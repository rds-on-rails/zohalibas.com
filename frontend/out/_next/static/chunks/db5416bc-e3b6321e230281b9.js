"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[898],{4373:function(e,t,r){r.d(t,{X:function(){return GoogleAuthProvider},aa:function(){return createUserWithEmailAndPassword},ab:function(){return signInWithEmailAndPassword},ak:function(){return updateProfile},c:function(){return signInWithPopup},o:function(){return getAuth},y:function(){return onAuthStateChanged}});var i=r(3991),n=r(8745),s=r(6914),a=r(44),o=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=_prodErrorMap,c=new n.LL("auth","Firebase",_prodErrorMap()),u=new s.Yd("@firebase/auth");function _logWarn(e,...t){u.logLevel<=s.in.WARN&&u.warn(`Auth (${i.Jn}): ${e}`,...t)}function _logError(e,...t){u.logLevel<=s.in.ERROR&&u.error(`Auth (${i.Jn}): ${e}`,...t)}/**
 * @license
